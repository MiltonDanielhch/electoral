                ...
                <div class="panel panel-bordered">
                    <div class="panel-body" style="padding: 0;">
                        <div class="col-md-8" style="padding: 0;">
                            <h1 class="page-title">
                                <i class="voyager-people"></i> Candidatos
                            </h1>
                        </div>
                        <div class="col-md-4 text-right" style="margin-top: 30px;">
                            @can('create', App\Models\Candidato::class)
                                <a href="{{ route('admin.candidatos.create') }}" class="btn btn-success">
                                    <i class="voyager-plus"></i> Nuevo Candidato
                                </a>
                            @endcan
                        </div>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="voyager-trash"></i> ¿Desea eliminar este candidato?</h4>
                </div>
...
@push('javascript')
    @include('admin.partials.list-browse-script', ['listUrl' => route('admin.candidatos.ajax.list')])
@endpush

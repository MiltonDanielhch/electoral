...
return new class extends Migration
{
    /**
     * Run the migrations.
     * Sintonía: Trigger de validación geofencing a nivel de base de datos
     * Código 3026-PLUS - Segunda capa de protección (PHP/JS ya validan)
     */
                ...
                IF NEW.latitud IS NOT NULL AND NEW.longitud IS NOT NULL THEN
                    IF NEW.latitud < -16.5 OR NEW.latitud > -10.0 OR 
                       NEW.longitud < -68.0 OR NEW.longitud > -60.0 THEN
                        ...
                        SET MESSAGE_TEXT = 'Sintonía Rota: Coordenadas fuera del Departamento del Beni (Lat: -16.5 a -10.0, Lon: -68.0 a -60.0)';
                    END IF;
                END IF;
            END
        ");
